...
class Pagination(object):
    ...
    def page_html(self):
        ...
        page_html_list = []
        self.params["page"] = 1
        first_page = '<li class="page-item"><a class="page-link" href="%s?%s">首页</a></li>' % (self.base_url, self.params.urlencode(),)
        ...
        if self.current_page <= 1:
            ...
            prev_page = '<li class="page-item"><a class="page-link" href="%s?%s">上一页</a></li>' % (self.base_url, self.params.urlencode(),)
        ...
        for i in range(pager_start, pager_end):
            ...
            if i == self.current_page:
                temp = '<li class="page-item" class="active"><a class="page-link" href="%s?%s">%s</a></li>' % (self.base_url, self.params.urlencode(), i,)
            else:
                temp = '<li class="page-item"><a class="page-link" href="%s?%s">%s</a></li>' % (self.base_url, self.params.urlencode(), i,)
            page_html_list.append(temp)

        if self.current_page >= self.all_pager:
            next_page = '<li class="page-item disabled"><a class="page-link" href="#">下一页</a></li>'
        else:
            self.params["page"] = self.current_page + 1
            next_page = '<li class="page-item"><a class="page-link" href="%s?%s">下一页</a></li>' % (self.base_url, self.params.urlencode(),)
        page_html_list.append(next_page)

        self.params["page"] = self.all_pager
        last_page = '<li class="page-item"><a class="page-link" href="%s?%s">尾页</a></li>' % (self.base_url, self.params.urlencode(),)
